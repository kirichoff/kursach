...
create unique index Category_categoryName_uindex on dbo.Category("categoryName");
...
create table dbo.Characteristic(
                               ...
                               constraint Fk_item_char
                                   foreign key ("itemId")
                                       references dbo.ShopItem on delete cascade
);
...
create table dbo.Cart(
                     ...
                     constraint FK_user_Cart
                         foreign key ("userId")
                             references dbo.UserShop
);
create unique index Cart_ItemId_uindex on dbo.Cart("ItemId");
...
create table dbo.Rating(
                       ...
                       constraint Rating_UserShop_userId_fk
                           foreign key ("userId")
                               references dbo.UserShop on delete cascade,
                       constraint Rating_ShopItem_ShopItemId_fk
                           foreign key ("itemId")
                               references dbo.ShopItem on delete cascade
);
create unique index UserShop_email_uindex on dbo.UserShop("email");
